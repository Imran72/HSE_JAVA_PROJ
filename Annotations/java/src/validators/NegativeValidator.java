...
/**
 * Класс, в котором осуществляется проверка поля с аннотацией @Negative.
 */
public class NegativeValidator implements Validator {
    ...
    /**
     * Проверка, аннотированого поля @Negative
     *
        ...
        if (object != null) {
            if (object instanceof Number) {
                ...
                if (value.longValue() >= 0) {
                    StringBuilder message = new StringBuilder("must be negative");
